...
def getarg_general(parser, dim=2):
    ...
    flags.add_argument('-n1',
                       '--n1',
                       type=int,
                       help='Number of points in first dimension',
                       required=True)
    ...
    parser.add_argument('-size1',
                        '--size1',
                        type=str,
                        help='Axis 1 size in inch',
                        required=False,
                        default='')
    parser.add_argument('-size2',
                        '--size2',
                        type=str,
                        help='Axis 2 size in inch',
                        required=False,
                        default='')
    parser.add_argument('-mask',
                        ...
                        required=False,
                        default='')
    parser.add_argument('-flip1',
                        '--flip1',
                        type=int,
                        help='Flip first dimension',
                        required=False,
                        default=0)
    ...
    if dim == 3:
        ...
        parser.add_argument(
            ...
            type=str,
            help=
            'Position of slice on axis 1, in consistent with actual value of axis',
            required=False,
            default='')
        parser.add_argument(
            '-slice2',
            ...
            type=str,
            help=
            'Position of slice on axis 2, in consistent with actual value of axis',
            required=False,
            default='')
        parser.add_argument(
            '-slice3',
            ...
            type=str,
            help=
            'Position of slice on axis 3, in consistent with actual value of axis',
            required=False,
            default='')
...
if <0, then axis tick values descending''',
        ...
        parser.add_argument(
            ...
            type=str,
            help=
            'Axis label of the third dimension; Use $$ to render TeX symbols',
            required=False,
            default='Axis 3')
        parser.add_argument(
            '-label3pad',
        ...
        parser.add_argument(
            ...
            type=str,
            help=
            'Axis 3 begin value, in consistent with the real value of axis',
            required=False,
            default='')
        parser.add_argument(
            '-x3end',
...
def getarg_color(parser):
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        'Set the color rendering range to +-clip; Default is the whole array value range',
        required=False,
        default='')
    parser.add_argument(
        '-cmin',
...
Default colormap is jet''',
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        'Figure colormap truncation begin; Valid value is [0,1], =0 by default',
        required=False,
        default='0.0')
    parser.add_argument(
        '-ctruncend',
        ...
        type=str,
        help=
        'Figure colormap truncation end; Valid value is [0,1], =1.0 by default',
        required=False,
        default='1.0')
    parser.add_argument(
        '-backctruncbeg',
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        '''Image interpolation method, =nearest by default, none, Gaussian, bicubic, etc.;
Not applicable for showvolume''',
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        '''Background image interpolation method, =nearest by default, none, Gaussian, bicubic, etc.;
Not applicable for showvolume''',
        required=False,
        default='none')
    #    parser.add_argument(
...
def getarg_colorbar(parser):
    ...
    parser.add_argument(
        ...
        '--legend',
        type=int,
        help='Show colorbar, =0 by default (no colorbar), =1 with colorbar',
        required=False,
        default=0)
    parser.add_argument(
        '-legendloc',
    ...
    parser.add_argument(
        ...
        type=int,
        help=
        'Number of minor ticks between two major colorbar ticks, =0 by default',
        required=False,
        default=0)
    parser.add_argument('-ld',
                        '--ld',
                        type=str,
                        help='Colorbar tick interval',
                        required=False,
                        default='')
    ...
    parser.add_argument('-lreverse',
                        '--lreverse',
                        type=int,
                        help='Reverse colorbar (=1) or not (=0, default)',
                        required=False)
    parser.add_argument(
        '-backlegend',
        '--backlegend',
        type=int,
        help=
        'Show colorbar of background image, =0 by default (no colorbar), =1 with colorbar',
        required=False,
        default=0)
...
def getarg_tick(parser, dim):
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        '''Mannualy set ticks along axis 1; e.g., 100,'Planet1':300,'Planet2' ''',
        required=False,
        nargs='+',
        default='')
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        'Length of minor ticks, =0.5*tickmajorlen by default, unit is pt. ',
        required=False,
        default='')
    parser.add_argument(
        '-tickmajorwid',
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        'Width of minor ticks, =0.75*tickmajorwid by default, unit is pt. ',
        required=False,
        default='')
    ...
    parser.add_argument('-ticktop',
                        '--ticktop',
                        type=str,
                        help='Ticks on the top axis, =on (default) or =off',
                        required=False,
                        default='on')
    parser.add_argument('-tickbottom',
                        '--tickbottom',
                        type=str,
                        help='Ticks on the bottom axis, =on or =off (default)',
                        required=False,
                        default='off')
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        '''Axis 1 tick label format, =plain or =sci by default, or any legal format''',
        required=False,
        default='sci')
    parser.add_argument(
        '-tick2format',
        ...
        type=str,
        help=
        '''Axis 2 tick label format, =plain or =sci by default, or any legal format''',
        required=False,
        default='sci')
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        '''Style of grid lines along axis 1, available styles: solid or - (default), dashed or --,
dashdot or -., dotted or :''',
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        '''Style of grid lines along axis 2, available styles: solid or - (default), dashed or --,
dashdot or -., dotted or :''',
        required=False,
        default='-')
    ...
    if dim == 3:
        ...
        parser.add_argument(
            ...
            '--grid3',
            type=str,
            help='Grid lines along axis 3, =on or =off (default)',
            required=False,
            default='off')
        ...
        parser.add_argument(
            ...
            type=str,
            help=
            '''Style of grid lines along axis 3, available styles: solid or - (default), dashed or --,
dashdot or -., dotted or :''',
            required=False,
            default='-')
        parser.add_argument(
        ...
        parser.add_argument('-tick3label',
                            '--tick3label',
                            type=str,
                            help='Axis 3 tick labels, =on (default) or off',
                            required=False,
                            default='on')
        parser.add_argument(
            '-tick3format',
            ...
            type=str,
            help=
            '''Axis 3 tick label format, =plain or =sci by default, or any legal format''',
            required=False,
            default='sci')
        parser.add_argument(
            '-ticks',
            '--ticks',
            type=str,
            help='Axis 1,2,3 tick labels, =on (default) or off',
            required=False,
            default='on')
...
=1.0 default, separated by comma, e.g., 1.0,2.0,3.0.,...''',
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        '''(Face) color of curves, separated by comma, e.g., k,b,w,y,...''',
        nargs='+',
        required=False,
        default='')
    parser.add_argument(
...
integer values only; the higher the shallower; =9 by default''',
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        'Extra text on the plot, separated by comma, e.g.,text1,text2,... ',
        nargs='+',
        required=False,
        default='')
...
separted by comma, e.g., 1,0,1,1,1,... ''',
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        'Text bounding box transparency =0.5 by default, separated by comma ',
        nargs='+',
        required=False,
        default='')
    parser.add_argument(
        ...
        type=str,
        help=
        'Pad size of bounding box around text, =10 by default, separted by comma ',
        nargs='+',
        required=False,
        default='')
...
=7 by default''',
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        '''Circle center coodinates (x1,x2), circle radius (width and height)
...
def getarg_contour(parser):
    ...
    parser.add_argument(
        ...
        type=int,
        help=
        'Contour overlays on the image, =0 (by default, no overlay) or =1 (overlay)',
        required=False,
        default=0)
...
def getarg_wiggle(parser):
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        '''Colors of the wiggles, separated by comma for different input files,
...
colors in a cycle manner: k,b,r,g,yellow,p,c,b,r,g,yellow,p,c,b,r,g,yellow ''',
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        '''Widths of the wiggles, separated by comma for different input files;
    ...
    parser.add_argument(
        ...
        type=int,
        help=
        '''Fill the positive or negative part of the wiggles with wiggles' color,
    ...
    parser.add_argument(
        ...
        type=int,
        help=
        'Show every N traces to avoid crowd figure; =1 by default (show all traces)',
        required=False,
        default=1)
