...
-size1=2 -size2=4.5 -legend=1 -lloc=bottom -unit='P-wave Velocity (m/s)' -lmtick=9 \
...
-ticks2=0,'Inline 4\n Cross 4':550,'Monday':100,'10\n100':450,'20\nCross' -mtick1=3 -mtick2=4 -legend=1 -color=coldwarm  -label2='Conductivity $\\log \\pi \\xi +\\Delta \\gamma \\pi$' -font=consolas -lloc=bottom -unit='Gaussian 10$\\mathregular{^{abc123}}$, Diffusitivity <$\\chi(\\mathbf{x})$>' -label1='Seawater level $\\psi=\\sqrt{\\cos(a)+b}$'"
