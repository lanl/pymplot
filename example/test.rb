...
#-------------------------------------------------------------------------------
# 3D volume plot with a random data
system "x_showvolume -in=./data/testdata_volumerand.bin -n1=12 -n2=20 \
-n3=30 -d1=0.1 -tick1format='%.2f' -o2=-2 -o1=-1 -o3=-1 -out=test_vol_random.pdf -centerframe=n \
-dpi=400 -angle=30,10 -color=jet -tick1d=0.2 -tick2d=1 -tick3d=1 \
-x2end=6 -x3end=4 -slice2=2 -slice3=2 \
...
-close=y,y -linestyle=-,- -plotlabel='qP':'qSV' &"

system "x_showgraph -in=./data/randdata.bin -n1=100 -ptype=3 -out=test_randgraph.pdf \
 -color=jet -legend=y -x1beg=10 -x2beg=10 -x1end=1000 -x2end=1000 \
-grid1=y -grid2=y -mgrid2=y -mtick1=5 -mtick2=5 -size1=4 \
...
-size1=2 -size2=4.5 -legend=y -lloc=bottom -unit='P-wave Velocity (m/s)' -lmtick=9 \
...
-slice1=1 -slice2=2 -slice3=3 -lmtick=9 -tr=over3d.png \
...
#-------------------------------------------------------------------------------
# 2D matrix plot with flexible ticks
system "x_showmatrix -in=./data/vp.bin -n1=300 -out=test_flexible_tick.pdf -ticks1=0:'Inline 4\n Cross 4',300:'20\nCross',100:'10\n$10^3$' \
-ticks2=0:'Inline 4\n Cross 4',550:'Monday',100:'10\n100',450:'20\nCross' -mtick1=3 -mtick2=4 -legend=y -color=coldwarm  -label2='Conductivity $\\log \\pi \\xi +\\Delta \\gamma \\pi$' -font=consolas -lloc=bottom -unit='Gaussian 10$\\mathregular{^{abc123}}$, Diffusitivity <$\\chi(\\mathbf{x})$>' -label1='Seawater level $\\psi=\\sqrt{\\cos(a)+b}$'"
...
-mtick1=4 -mtick2=4 \
-legend=y -lmtick=4 -polygon=0.6,58,4,58,4,63,0.6,63 -polygonfacecolor=none \
